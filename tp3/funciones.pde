void ilusion() {//creo una funcion nueva de nombre ilusion
  ...
  for (int i=0; i < cant; i++) { //inicio un ciclo for para la variable i, y le digo que para en 0, y siempre y cuando sea mayor a cant (que definimos con valor 20), vaya sumando 1 a i
    for (int j = 0; j < cant; j++) {//hacemos lo mismo pero para la variable j
      ...
      } else if (dist( i*tam, j*tam, mouseX-400, mouseY) < cant*5) {
      ...
      } else if (dist( i*tam+tam/2, j*tam+tam/2, mouseX-400, mouseY) < tam) {
